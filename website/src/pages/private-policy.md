...
This privacy notice for `app.tianji.dev` ("we," "us," or "our") explains how and why we collect, store, use, and/or share ("process") your personal information when you use our services ("Services"). This includes actions like:

- Visiting our website at `tianji.dev`, or any other website of ours that links to this privacy notice.
...
If you sign up for our website `app.tianji.dev` through Google, you authorize us to collect authentication information, including your username, encrypted access credentials, and any other personal data available through your third-party application account.
...
- **Provide, Improve, and Develop the Platform**: We process your data primarily to ensure the proper functioning of our website. We may also use your data to improve our website and offer you the best possible experience. Specifically, we:
  - Operate and maintain your `app.tianji.dev` account, allowing you to access and use the Platform. Your email address and password are used to identify you when you log in.
...
- **Through Your Profile**: Any personal data you choose to disclose in your public profile on `app.tianji.dev` will be visible to other users. They may view your profile information and interact with any public prompts you share.
...
- **Compliance with Laws**: We may disclose your personal data to courts, law enforcement agencies, or government authorities if required to:
  ...
  - Respond to claims against `app.tianji.dev`.
  - Address verified requests related to criminal investigations or alleged illegal activities.
  - Enforce our Terms of Use and other agreements.
  - Protect the rights, property, or personal safety of `app.tianji.dev`, its employees, and the public.

## Data Storage and Location

Tianji Cloud (`app.tianji.dev`) is hosted in Frankfurt, Germany. Customer data, including account information, analytics events, monitoring results and survey responses, is stored in a data center located in Frankfurt, within the European Union.

If you self-host Tianji, your data is stored wherever you deploy it.

## Information Security

`app.tianji.dev` implements technical, administrative, and physical safeguards designed to prevent unauthorized access, use, or disclosure of the personal data we collect or store. These measures are intended to ensure a level of security appropriate to the risk involved. We regularly monitor our systems for vulnerabilities and potential attacks. However, no internet transmission is completely secure, so you provide personal data at your own discretion and risk.
